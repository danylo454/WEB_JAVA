...
public class FileSystemStorageService implements StorageService {
    ...
    public Resource loadAsResource(String filename) {
        try {
            ...
            throw new StorageException("Файл не знайдено: " + filename, ex);
        }
    }
...
//створюємо буфер для нової фотографії, де важливо вказуємо розширення яке буде у фотки та розмір (32х32, 150х150)
                    ...
                    ImageIO.write(newImg, extension, byteArrayOutputStream); //Wза допомогою цього Stream записуємо в буфер фотографію згідно з розширенням
